...
$phone = $conn->real_escape_string(trim(filter_input(INPUT_GET, 'phone', FILTER_DEFAULT)));

//define MySQL update statement
$sql = "UPDATE users SET user_name = '$user_name', full_name = '$full_name', user_email = '$user_email', user_phone = '$phone' WHERE user_id = $user_id";
